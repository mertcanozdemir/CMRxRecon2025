...
% TrainingSet
basePath = ['/SSDHome/share/ChallengeData/MultiCoil'];
                    ...
                    for ind222 = 1 : fileVDLen
                        ...
                        for ind3 = 1 : fileIDLen
                            ...
                            for ind4 = 1 : filematLen
                                ...
                                %% Different .mat files
                                if contains(imgName,'.mat') && ~contains(imgName,'.bak') && ~contains(imgName,'mask') && ~contains(imgName,'kus')
                                    ...
                                    if strcmp(file_nameSet,'TrainingSet') && strcmp(file_nameSet,setName)
                                        ...
                                        for i = 1 : length(patterns)
                                            pattern = patterns{i};
                                            for R = [8,16,24]
                                                ChallengeMaskGen_TrainingSet(data_path,mainSavePath,pattern,R,file_nameCT,file_nameVD,file_nameID,dataName,file_nameSet);
